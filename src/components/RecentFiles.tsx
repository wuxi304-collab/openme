    ...
    <div className="flex flex-col h-full">
      {files.length === 0 ? (
        <div className="flex flex-col items-center justify-center flex-1 gap-3 px-6 text-center">
          <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="var(--text-muted)" strokeWidth="1.2" opacity="0.5" aria-hidden="true">
              ...
              <li key={file.id}>
                <button
                  onClick={() => onSelect(file)}
                                  className="w-full text-left px-3 py-2.5 flex items-center gap-3 group transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[var(--accent)]"
                  style={{
                    background: isSelected ? "var(--accent-glow)" : "transparent",
                                ...
                                >
                                  ...
                                  {isSelected && (
                                    <div className="w-1.5 h-1.5 rounded-full flex-shrink-0" style={{ background: "var(--accent)" }} aria-hidden="true" />
                                  )}
                                </button>
              </li>
            );
