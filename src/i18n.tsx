...
export const translations: Record<string, Record<string, string>> = {
  zh: {
    ...
    light: "明亮",
    dark: "暗色",
    themeToggleToLightAria: "切换到明亮主题",
    themeToggleToDarkAria: "切换到暗色主题",
    themeAnnouncedLight: "已切换到明亮主题",
    themeAnnouncedDark: "已切换到暗色主题",
    maximizeAnnouncedMax: "窗口已最大化",
    maximizeAnnouncedRestore: "窗口已还原",
    language: "语言",
    chinese: "中文",
    english: "English",
    selectFile: "选择文件",
    ...
    statusEncodingDefault: "UTF-8（默认）",
    statusLineEndingDefault: "未检测",
    statusLinesChip: "{count} 行",
    statusLinesAria: "{count} 行",
    ...
    appMainAria: "文件查看器主区域",
    paletteNavHint: "↑↓ 选择",
    paletteEnterHint: "Enter 执行",
    paletteEscHint: "Esc 关闭",
    paletteHintsGroupAria: "键盘操作提示",
    paletteSelectionAnnounce: "已选中第 {index} 项，共 {total} 项：{label}",
    paletteResultsAnnounce: "{count} 条结果",
    ...
    // PR #152 — FileSummaryPanel routing fidelity row (viewer-matrix integration)
    summaryRouting: "路由保真度",
    summaryRoutingLevel: "等级",
    summaryRoutingAdapter: "适配器",
    summaryLevelDirect: "直接预览",
    summaryLevelSemantic: "语义检查",
    summaryLevelCard: "安全卡片",
    summaryLevelGuarded: "受控卡片",
    summaryRoutingHint: "direct=原生预览 · semantic=仅元信息 · card=安全兜底 · guarded=受限路由",
    // PR #153 — Relative time strings for src/utils/format.ts
    relativeTimeJustNow: "刚刚",
    relativeTimeSeconds: "{n, plural, other {# 秒前} }",
    relativeTimeMinutes: "{n, plural, other {# 分钟前} }",
    relativeTimeHours: "{n, plural, other {# 小时前} }",
    relativeTimeDays: "{n, plural, other {# 天前} }",
    capDetect: "检测",
    capPreview: "预览",
    capEdit: "编辑",
    capMetadata: "元数据",
    ...
    csvSearchClearAria: "清除搜索",
    csvPageSizeAria: "每页行数",
    csvPageSizeOption: "每页 {count} 行",
    csvPaginationAria: "翻页",
    csvPageIndicator: "第 {current} / {total} 页",
    csvPrev: "上一页",
    csvNext: "下一页",
    csvCol: "第 {n} 列",
    ...
    pdfSearchPrevAria: "上一个匹配",
    pdfSearchNextAria: "下一个匹配",
    pdfMatchCursor: "{current} / {total}",
    pdfFitWidthAria: "适应窗口宽度",
    pdfZoomOutAria: "缩小",
    pdfZoomInAria: "放大",
    pdfResetZoomAria: "重置缩放",
    pdfStageAria: "PDF 页面",
    pdfRenderingPageWithNumber: "正在绘制第 {current} / {total} 页…",
    pdfStatusBar: "第 {current} / {total} 页 · {percent}%",
    ...
    mediaBadgeVideo: "影",
    mediaBadgeAudio: "声",
        mediaAudioToolbarAria: "音频工具栏",
        mediaVideoToolbarAria: "视频工具栏",
        mediaAudioStageAria: "音频播放区",
        mediaVideoStageAria: "视频播放区",
    ...
    mediaDecodeFailedTitle: "音频解码失败",
    mediaDecodeFailedHint: "OpenMe 内置的 ffmpeg 解码器无法解码该文件。可点击「用系统程序打开」交给系统播放器，或展开下方的技术详情查看 ffmpeg 报错。",
    mediaDecodeFailedDetailLabel: "技术详情",
    mediaDecodeFailedCopy: "复制错误信息",
    mediaDecodeFailedCopied: "错误信息已复制到剪贴板",
    mediaUnsupportedTitle: "当前音频格式无法内置解码",
    mediaUnsupportedBody: "OpenMe 已识别文件元数据，但 Chromium 内置解码器不支持当前格式。可在下方打开系统默认播放器，或选用其他工具。",
    mediaUnsupportedSuggestions: "建议方案：用系统默认播放器打开，或使用支持该格式的专业音频工具（如 foobar2000、Audacious、HQPlayer）。",
    mediaUnsupportedActionSystem: "用系统程序播放",
    mediaUnsupportedTryAnyway: "还是尝试内置播放",
    mediaUnsupportedTryAnywayAria: "忽略自动检测，仍然尝试用内置播放器打开此音频",
    mediaUnsupportedReasonDsd: "DSD（.dsf / .dff）是 1-bit 高码率格式，Chromium 不支持原生解码。建议用 foobar2000、HQPlayer 或其他支持 DSD 的播放器。",
    mediaUnsupportedReasonAlacCaf: "ALAC 在独立 CAF 容器中目前无法被 Chromium 解码，但包在 MP4 容器内（.m4a）时可以播放。",
    mediaUnsupportedReasonAiff: "AIFF（AIF / AIFF）在当前 Chromium 版本中可能无法解码。建议转换到 WAV 或 FLAC 后再打开。",
    mediaUnsupportedReasonApe: "Monkey's Audio（.ape）不受 Chromium 支持。建议用 foobar2000 或转换到 FLAC。",
    mediaUnsupportedReasonWma: "WMA 是 Windows Media 专有格式，Chromium 不支持。建议用 foobar2000 或 VLC。",
    mediaUnsupportedReasonTak: "TAK（Tom's Lossless Audio Kompressor）是稀有格式，Chromium 不支持。建议用 foobar2000。",
    mediaUnsupportedReasonWavpack: "WavPack（.wv）不被 Chromium 支持。建议用 foobar2000 或转换到 FLAC。",
    mediaUnsupportedReasonGeneric: "Chromium 无法解码此音频文件。",
    audioUnsupportedMetaAria: "已识别的格式元数据",
    ...
    officeExcelPrevAria: "上一页",
    officeExcelNextAria: "下一页",
    officeExcelPaginationAria: "工作表分页",
    officeSheetTabsAria: "工作表标签",
    officeWordToolbarAria: "Word 文档工具栏",
    officePptxToolbarAria: "PPTX 工具栏",
    officePptxLabel: "PowerPoint",
    officeWordCount: "{count} 个词",
    officeWordCountPending: "正在统计…",
    officeWordCopy: "复制纯文本",
    officeWordCopyAria: "复制为纯文本",
    officeWordCopied: "已复制",
    ...
    saveFailed: "保存失败",
    saveAllSuccess: "已保存全部 {count, plural, one {# 个文件} other {# 个文件}}",
    saveAllPartial: "{total, plural, one {# 个文件中已保存 {saved} 个} other {# 个文件中已保存 {saved} 个}}，{failed, plural, one {# 个失败} other {# 个失败}}",
    saveAllFailed: "{count, plural, one {# 个文件保存失败} other {# 个文件保存失败}}",
    readFailed: "读取失败",
    ...
    cmdSaveAll: "保存全部文件",
    cmdSaveAllDetail: "{count, plural, one {# 个未保存标签} other {# 个未保存标签}}",
    cmdSaveAllDetailEmpty: "没有未保存修改",
    ...
    shortcutsJumpTab: "跳转到指定标签",
    shortcutsShowOverlay: "显示全局快捷键",
    shortcutsCloseOverlay: "关闭当前对话框",
    shortcutsGroupCount: "{count} 项",
    shortcutsKeysSingle: "单键",
    shortcutsGroupAria: "{group} 快捷键分组，共 {count} 项",
    shortcutsSearchPlaceholder: "筛选快捷键…",
    shortcutsSearchAria: "筛选快捷键",
    shortcutsSearchNoResults: "没有匹配 \"{query}\" 的快捷键",
    shortcutsSearchHint: "按 / 聚焦搜索框",
    shortcutsSearchSummary: "显示 {shown} / {total} 条",
    shortcutsSearchEmptyHint: "试试 \"Ctrl\"、\"标签\"、\"打开\"",
    ...
    aboutCopiedAria: "版本信息已复制到剪贴板",
        ...
        aboutAckDescription: "本项目使用了以下开源项目（按字母顺序）",
                aboutAckPurposeElectron: "桌面运行时",
                aboutAckPurposeReact: "界面框架",
                aboutAckPurposeMonacoEditor: "代码编辑器",
                aboutAckPurposePdfJs: "PDF 渲染",
                aboutAckPurposeThreeJs: "DWG 与三维渲染",
                aboutAckPurposeMammoth: "DOCX 转 HTML",
                aboutAckPurposeSheetJs: "XLSX 解析",
                aboutAckPurposeJsZip: "ZIP 压缩包处理",
                aboutAckPurposeEpubJs: "EPUB 阅读器",
                aboutAckPurposeOpentypeJs: "字体检查",
    ...
    windowControlsAria: "窗口控制",
                ...
                splashMilestoneRecentFiles: "加载最近文件",
                                splashMilestoneViewerRegistry: "注册文件查看器",
                splashMilestoneReady: "全部就绪",
                        // JsonViewer v2
                        jsonSearchPlaceholder: "搜索键或值",
                        jsonSearchAria: "搜索 JSON",
                        jsonSearchNoMatch: "未找到匹配项",
                        jsonSearchMatchCount: "找到 {count} 项",
                        jsonExpandAll: "全部展开",
                        jsonCollapseAll: "全部折叠",
                        jsonCopyPath: "复制路径",
                        jsonCopyPathHint: "先选中一个节点",
                        jsonCopied: "已复制",
                        jsonStatusIdle: "使用方向键浏览",
                        aboutMemoryGb: "{n} GB",
        aboutCpusCount: "{n} 核",
    ...
    light: "Light",
    dark: "Dark",
    themeToggleToLightAria: "Switch to light theme",
    themeToggleToDarkAria: "Switch to dark theme",
    themeAnnouncedLight: "Switched to light theme",
    themeAnnouncedDark: "Switched to dark theme",
    maximizeAnnouncedMax: "Window maximized",
    maximizeAnnouncedRestore: "Window restored",
    language: "Language",
    chinese: "中文",
    english: "English",
    ...
    statusBarAria: "File status bar",
    statusLineEndingLabel: "Line ending",
    statusLineEndingLF: "LF (Unix)",
    statusEncodingDefault: "UTF-8 (default)",
    statusLineEndingDefault: "Not detected",
    statusLinesChip: "{count} lines",
    statusLinesAria: "{count} lines",
    ...
    appMainAria: "File viewer main area",
    paletteNavHint: "↑↓ to navigate",
    paletteEnterHint: "Enter to run",
    paletteEscHint: "Esc to close",
    paletteHintsGroupAria: "Keyboard shortcuts",
    paletteSelectionAnnounce: "Item {index} of {total}: {label}",
    paletteResultsAnnounce: "{count, plural, =0 {No results} one {# result} other {# results}}",
    ...
    // PR #152 — FileSummaryPanel routing fidelity row (viewer-matrix integration)
    summaryRouting: "Routing fidelity",
    summaryRoutingLevel: "Level",
    summaryRoutingAdapter: "Adapter",
    summaryLevelDirect: "Direct preview",
    summaryLevelSemantic: "Semantic inspector",
    summaryLevelCard: "Safe route card",
    summaryLevelGuarded: "Guarded route card",
    summaryRoutingHint: "direct = native preview · semantic = metadata only · card = safe fallback · guarded = restricted route",
    // PR #153 — Relative time strings for src/utils/format.ts
    relativeTimeJustNow: "just now",
    relativeTimeSeconds: "{n, plural, one {1 second ago} other {# seconds ago} }",
    relativeTimeMinutes: "{n, plural, one {1 minute ago} other {# minutes ago} }",
    relativeTimeHours: "{n, plural, one {1 hour ago} other {# hours ago} }",
    relativeTimeDays: "{n, plural, one {1 day ago} other {# days ago} }",
    capDetect: "Detect",
    capPreview: "Preview",
    capEdit: "Edit",
    ...
    csvSearchClearAria: "Clear search",
    csvPageSizeAria: "Rows per page",
    csvPageSizeOption: "{count} / page",
    csvPaginationAria: "Pagination",
    csvPageIndicator: "Page {current} / {total}",
    ...
    pdfSearchPrevAria: "Previous match",
    pdfSearchNextAria: "Next match",
    pdfMatchCursor: "{current} / {total}",
    pdfFitWidthAria: "Fit width",
    pdfZoomOutAria: "Zoom out",
    pdfZoomInAria: "Zoom in",
    pdfResetZoomAria: "Reset zoom",
    pdfStageAria: "PDF page",
    pdfRenderingPageWithNumber: "Rendering page {current} / {total}…",
    pdfStatusBar: "Page {current} / {total} · {percent}%",
    ...
    mediaBadgeVideo: "Vid",
    mediaBadgeAudio: "Aud",
        mediaAudioToolbarAria: "Audio toolbar",
        mediaVideoToolbarAria: "Video toolbar",
        mediaAudioStageAria: "Audio playback area",
        mediaVideoStageAria: "Video playback area",
        mediaVideoErrorTitle: "Video cannot be played inline",
    mediaAudioErrorTitle: "Audio cannot be played inline",
    mediaDecodeFailedTitle: "Audio decoder failed",
    mediaDecodeFailedHint: "OpenMe's built-in ffmpeg decoder could not decode this file. Click \"Open in system\" to hand it off, or expand the technical details below to inspect the raw ffmpeg error.",
    mediaDecodeFailedDetailLabel: "Technical details",
    mediaDecodeFailedCopy: "Copy error message",
    mediaDecodeFailedCopied: "Error message copied to clipboard",
    ...
    mediaUnsupportedTitle: "Audio codec not supported by the built-in player",
    mediaUnsupportedBody: "OpenMe has read the file's metadata, but the Chromium decoder does not support this format. Open it with your system's default player below, or pick another tool.",
    mediaUnsupportedSuggestions: "Suggested options: open with your system's default player, or use a tool that supports this format (foobar2000, Audacious, HQPlayer, ...).",
    mediaUnsupportedActionSystem: "Open in system player",
    mediaUnsupportedTryAnyway: "Try built-in playback anyway",
    mediaUnsupportedTryAnywayAria: "Ignore the automatic codec check and attempt built-in playback for this audio file",
    mediaUnsupportedReasonDsd: "DSD (.dsf / .dff) is a 1-bit high-rate format and is not decoded natively by Chromium. Try foobar2000, HQPlayer, or another DSD-capable player.",
    mediaUnsupportedReasonAlacCaf: "ALAC inside a standalone .caf container is not decoded by Chromium, but it plays fine inside an .m4a (MP4) container.",
    mediaUnsupportedReasonAiff: "AIFF (AIF / AIFF) may not decode in this Chromium build. Convert to WAV or FLAC to play it.",
    mediaUnsupportedReasonApe: "Monkey's Audio (.ape) is not supported by Chromium. Try foobar2000 or convert to FLAC.",
    mediaUnsupportedReasonWma: "WMA is a proprietary Windows Media format and is not decoded by Chromium. Try foobar2000 or VLC.",
    mediaUnsupportedReasonTak: "TAK (Tom's Lossless Audio Kompressor) is an obscure format that Chromium does not decode. Try foobar2000.",
    mediaUnsupportedReasonWavpack: "WavPack (.wv) is not decoded by Chromium. Try foobar2000 or convert to FLAC.",
    mediaUnsupportedReasonGeneric: "Chromium cannot decode this audio file.",
    audioUnsupportedMetaAria: "Format metadata",
    ...
    losslessDecoding: "Decoding audio…",
    ...
    officeExcelPrevAria: "Previous page",
    officeExcelNextAria: "Next page",
    officeExcelPaginationAria: "Sheet pagination",
    officeSheetTabsAria: "Sheet tabs",
    officeWordToolbarAria: "Word document toolbar",
    officePptxToolbarAria: "PPTX toolbar",
    officePptxLabel: "PowerPoint",
    officeWordCount: "{count} words",
    officeWordCountPending: "Counting…",
    officeWordCopy: "Copy text",
    officeWordCopyAria: "Copy as plain text",
    officeWordCopied: "Copied",
    ...
    saveAllSuccess: "Saved all {count, plural, one {# file} other {# files}}",
    saveAllPartial: "{total, plural, one {Saved {saved} of #} other {Saved {saved} of #}}, {failed, plural, one {# failed} other {# failed}}",
    saveAllFailed: "Failed to save {count, plural, one {# file} other {# files}}",
    ...
    cmdSaveAllDetail: "{count, plural, one {# unsaved tab} other {# unsaved tabs}}",
    cmdSaveAllDetailEmpty: "No unsaved changes",
    ...
    shortcutsJumpTab: "Jump to a specific tab",
    shortcutsShowOverlay: "Show keyboard shortcuts",
    shortcutsCloseOverlay: "Close the current dialog",
    shortcutsGroupCount: "{count} shortcuts",
    shortcutsKeysSingle: "single key",
    shortcutsGroupAria: "{group} shortcuts, {count} items",
    shortcutsSearchPlaceholder: "Filter shortcuts…",
    shortcutsSearchAria: "Filter shortcuts",
    shortcutsSearchNoResults: "No shortcuts match \"{query}\"",
    shortcutsSearchHint: "Press / to focus search",
    shortcutsSearchSummary: "Showing {shown} of {total} entries",
    shortcutsSearchEmptyHint: "Try \"Ctrl\", \"Tab\", or \"Open\"",
    ...
    aboutCopiedAria: "Version information copied to clipboard",
        ...
        aboutAckDescription: "Built on the shoulders of these open-source projects (alphabetical)",
                aboutAckPurposeElectron: "Desktop runtime",
                aboutAckPurposeReact: "UI framework",
                aboutAckPurposeMonacoEditor: "Code editor",
                aboutAckPurposePdfJs: "PDF rendering",
                aboutAckPurposeThreeJs: "DWG and 3D rendering",
                aboutAckPurposeMammoth: "DOCX to HTML conversion",
                aboutAckPurposeSheetJs: "XLSX parsing",
                aboutAckPurposeJsZip: "ZIP archive handling",
                aboutAckPurposeEpubJs: "EPUB reader",
                aboutAckPurposeOpentypeJs: "Font inspection",
    ...
    windowControlsAria: "Window controls",
                ...
                splashMilestoneReady: "All set",
                        ...
                        jsonSearchAria: "Search JSON",
                        jsonSearchNoMatch: "No matches",
                        jsonSearchMatchCount: "{count} match(es)",
                        jsonExpandAll: "Expand all",
                        jsonCollapseAll: "Collapse all",
                        jsonCopyPath: "Copy path",
                        jsonCopyPathHint: "Select a node first",
                        jsonCopied: "Copied",
                        jsonStatusIdle: "Use arrow keys to navigate",
                        aboutMemoryGb: "{n} GB",
